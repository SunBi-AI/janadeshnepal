...
export default function Policies() {
  ...
  const categories = useMemo(() => {
    if (!policies || policies.length === 0) return [{ id: 'all', name_en: 'All', name_ne: 'सबै' }];
  ...
  return (
    ...
    <section className="bg-[#fafafa]">
      ...
      <Container className="py-14">
        ...
        {isError && <p className="text-center py-20 text-red-500">Error loading policies</p>}

        {/* Category buttons + search (only if policies exist) */}
        {policies.length > 0 && (
